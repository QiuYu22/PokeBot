...
public static class NetUtil
{
    ...
    public static async Task<Download<PKM>> DownloadPKMAsync(IAttachment att, SimpleTrainerInfo? defTrainer = null)
    {
        ...
        {
            result.ErrorMessage = $"{result.SanitizedFileName}：大小无效。";
            return result;
        }
        string url = att.Url;
        ...
        if (pkm is null)
        {
            result.ErrorMessage = $"{result.SanitizedFileName}：附件不是有效的 PKM 文件。";
            return result;
        }
        result.Data = pkm;
        result.Success = true;
    ...
    public static async Task<Download<PKM>> DownloadPKMAsync(string url, SimpleTrainerInfo? defTrainer = null)
    {
        ...
        try
        {
            ...
            if (pkm is null)
            {
                result.ErrorMessage = $"{result.SanitizedFileName}：该文件不是有效的 PKM。";
                return result;
            }
