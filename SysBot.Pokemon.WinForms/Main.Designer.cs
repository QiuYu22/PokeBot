...
namespace SysBot.Pokemon.WinForms
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            logSearchBox.PlaceholderText = "搜索日志 (Enter = 下一个, Shift+Enter = 上一个, Esc = 清除)...";
        ...
        private void ConfigureUpdateButton()
        {
            ...
            btnUpdate.MouseEnter += (s, e) => {
                ...
                if (mainForm != null && mainForm.hasUpdate)
                {
                    updateTooltip.SetToolTip(btnUpdate, "有可用更新！点击下载。");
                }
                else
                {
                    updateTooltip.SetToolTip(btnUpdate, "没有可用更新");
                }
            };
        ...
        private void ConfigureSystemTray()
        {
            ...
            trayMenuStart.Click += (s, e) => {
                ...
                LogUtil.LogInfo("已从托盘启动所有机器人", "托盘");
            };
            ...
            trayMenuStop.Click += (s, e) => {
                ...
                LogUtil.LogInfo("已从托盘停止所有机器人", "托盘");
            };
