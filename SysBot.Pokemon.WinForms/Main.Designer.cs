...
namespace SysBot.Pokemon.WinForms
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            logSearchBox.PlaceholderText = "搜索日志（Enter 下一条，Shift+Enter 上一条，Esc 清除）...";
            ...
            ConfigureSearchOption(btnWholeWord, "W", "整词匹配搜索");
        ...
        private void ConfigureUpdateButton()
        {
            ...
            btnUpdate.MouseEnter += (s, e) => {
                ...
                if (mainForm != null && mainForm.hasUpdate)
                {
                    updateTooltip.SetToolTip(btnUpdate, "发现新版本！点击下载。");
                }
                else
                {
                    updateTooltip.SetToolTip(btnUpdate, "已是最新版本");
                }
            };
        ...
        private void ConfigureSystemTray()
        {
            ...
            var trayMenuStart = new ToolStripMenuItem("启动所有机器人");
            ...
            trayMenuStart.Click += (s, e) => {
                ...
                LogUtil.LogInfo("通过托盘启动了所有机器人", "Tray");
            };

            var trayMenuStop = new ToolStripMenuItem("停止所有机器人");
            trayMenuStop.ForeColor = Color.FromArgb(236, 98, 95);
            trayMenuStop.Click += (s, e) => {
                RunningEnvironment.StopAll();
                LogUtil.LogInfo("通过托盘停止了所有机器人", "Tray");
            };
